...
@endif
 ...
 @if($showDiv2)
    ...
    @endif
<div wire:sortable="updateTaskOrder" wire:sortable.options="{ animation: 100 }">
<!-- #2471A3 -->
    @foreach($posts as $dbTask)
<div style="display: block; margin:auto; margin-bottom: 5px; width: 550px; cursor: pointer;  background-color: #34495E; border-radius:5px" wire:sortable.item="{{ $dbTask->id }}" wire:key="task-{{ $dbTask->id }}">
